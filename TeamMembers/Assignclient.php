 ...
 <div class="container-fluid p-0">
        ...
        <div class="container-fluid vc  ">
             <a class="btn text-center  btn-primary btn-sm mt-1 mb-1" href="../Team.php" >View Team Members</a>
              <a class="btn text-center  btn-primary btn-sm mt-1 mb-1" href="Analytics.php" >Analytics</a>
<!--             <a class="btn text-center  btn-primary btn-sm mt-1 mb-1 " data-toggle="modal" data-target="#AssignClient" >Assign client to Team</a>-->
             ...
             <button class="btn btn-sm text-white" id="verticaltable" onclick="toogle()">Show Vertical view</button>
        </div> 
 </div>
...
<!--                                                         <th class="text-center" data-toggle="tooltip" data-placement="top" title="view" scope="col">View</th>  -->
                                    ...
                                    <tbody id="dytable">
                                        ...
                                        <?php
                                        $sr = 1;
                                         $sql= "SELECT ClientDb.Full_Name, ClientDb.Email, TeamMembers.Name,TeamMembers.Surname,TeamMembers.Mail_Id, TeamMembers.UserName, assignteam.Status,assignteam.Sr_no, assignteam.Desc,assignteam.Status,assignteam.assign
...
<div class="modal fade" id="AssignClient" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class=" modal-xl modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <!-- Modal -->
<div class="modal fade" id="AssignEdit"  aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class=" modal-xl modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Client Assign</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
function editM(sr,Tname,notes,cname,status){
    console.log(sr);
     console.log(Tname);
      console.log(notes);
       console.log(cname);
