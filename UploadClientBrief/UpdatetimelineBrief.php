...
//    echo "</pre>";
    ...
    $ucid= mysqli_real_escape_string($con,$_POST['cid']);
     $uclientN=mysqli_real_escape_string($con,$_POST['UClientN']);
    $ucaseN= mysqli_real_escape_string($con,$_POST['UCaseN']);
    $updf= mysqli_real_escape_string($con,$_POST['UPdf']);
    $udate=mysqli_real_escape_string($con,$_POST['UDate']);
     $ustpg= mysqli_real_escape_string($con,$_POST['USTpg']);
    $uetpg= mysqli_real_escape_string($con,$_POST['UETpg']);
    $utdy= mysqli_real_escape_string($con,$_POST['UTDy']);
     $utitle=mysqli_real_escape_string($con,$_POST['UTitle']);
    $ucontent= mysqli_real_escape_string($con,$_POST['UEditor']); 
...
$sql = "UPDATE BreifTimeline_data SET Cid= '$ucid',Date='$udate',St_pg='$ustpg', Ed_pg='$uetpg', Doc_type='$utdy',Pdf_Name='$updf', Client_Name='$uclientN',Case_Name='$ucaseN',Title='$utitle',Content='$ucontent' WHERE Sr_no='$id'";
//echo $sql;
if ($con->query($sql) === TRUE) {
  echo "Record updated successfully";
   header("Location:http://apajuris.in/work/viewbriefs.php?v=$ucid");
} else {
...
$sr; $cid; $tdate; $st; $et; $doctype;$pdfn; $title ;$content;
	...
	$query = "SELECT * FROM BreifTimeline_data WHERE Sr_no = {$id}";
...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    ...
    <title>Update Timeline Brief!</title>
     <style>
         ...
         <div class="container-fluid border mt-4 shadow p-3 mb-5 bg-white rounded">
          <div class="row">
              <div class="col-lg-6 col-lg-6 col-sm-12">
                  <a href="../viewbriefs.php?v=<?php echo $cid?>" class="btn btn-primary mt-1"><- Back</a>
              </div>
                <div class="col-lg-6 col-lg-6 col-sm-12">
          <h3 class="mt-1 text-right text-uppercase"> Update Timeline Brief </h3>
              </div>
          </div>
                      ...
                      <div id="my_pdf_viewer" class="border">
                    	<div id="navigation_controls" class="text-center">
                            ...
                            <button class="btn btn-primary btn-sm" id="go_next">Next</button>
                             <input  class="form-sm text-center"id="current_page" value="1" type="number"/>
    ...
    <div id="navigation_controls" class="text-center">
         <button class="btn btn-primary btn-sm" id="Firstpg1">First page</button>
                         ...
                         <button class="btn btn-primary btn-sm"id="go_next1">Next</button>
                               <input class="form-sm text-center" id="current_page1" value="1" type="number"/>
