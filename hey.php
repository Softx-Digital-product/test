                                  ...
                                  <table class="table table-striped table-bordered  table-hover " id='Timelist'>
                                    <thead class="vbg text-white">
                                        <tr>
                                            ...
                                            <th class="text-center d-none "data-toggle="tooltip" data-placement="top" title="Edit"  scope="col">EDT</th>
                                        ...
                                        if ($num >= 0) {
                                            while ($row = mysqli_fetch_array($quariy)) {
                                                ?>
                                                   ...
                                                   <td class="text-center text-nowrap" scope="row"style="width:10%" data-toggle="tooltip" title="<?php echo $row['Date']?>"><?php echo $row['Date']?></td>
                                       
                                                                    <td class="text-center text-nowrap" scope="row"style="max-width:3rem;overflow: hidden" data-toggle="tooltip"  title="<?php echo $row['Doc_type']?>"><?php echo $row['Doc_type']?></td>

                                                                    <td class=" text-nowrap "id="editdelT" scope="row"style="max-width:5rem; overflow: hidden;"  dblclick="Edit(<?php echo $sr;?>,<?php echo $row['Sr_no'];?>,<?php echo $row['St_pg'];?>)"onclick="Etpg(<?php echo $sr;?>,<?php echo $row['St_pg']?>)" data-toggle="tooltip" title="<?php echo $row['Title']?>"><?php echo $row['Title']?></td>
                                                                    <?php $row['Content'] = strip_tags($row['Content']);?>

                                            <th class="text-center text-nowrap" scope="row"style="width:10%;cursor: pointer;"  data-toggle="modal" data-target="#viewcontent"onclick="dyfunction(<?php echo $row['Sr_no'];?>,<?php echo $sr;?>,<?php echo $row['St_pg']?>)"><a class='nav_link text-center '>View</a></th>                                                                    
                                                                       
                                                     <th class="text-center" scope="row" style="width:10%;cursor: pointer;" onclick="Etpg(<?php echo $sr;?>,<?php echo $row['St_pg']?>)">
                          <a class="nav_link no " ><?php echo $row['St_pg'] ?></a>
                                                    </th>
                                                 
              <th class="text-center" scope="row"style="cursor: pointer;width:10%;" onclick="Etpg(<?php echo $sr;?>,<?php echo $row['Ed_pg']?>)">
                  <a class="nav_link no"><?php echo $row['Ed_pg'] ?></a>                                 
              </th>

           
                    <th class="text-center d-none" scope="row"style="cursor: pointer;"><a class="nav-link" onclick="Edit(<?php echo $sr;?>,<?php echo $row['Sr_no'];?>,<?php echo $row['St_pg'];?>)">Edit</a>
                                  
                            </th>
                             <th class="text-center d-none" scope="row"style="cursor: pointer;">
