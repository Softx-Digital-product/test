...
// }
  ...
  $sql ="INSERT into Client_CaseDb (Client_Name,Case_Status,Court_Name,Case_Type,Case_SubType,Case_Categ,Case_SubCateg,Case_Name,Case_Number,Case_Year,Case_Desc) 
  VALUE('$clientName','$casestatus','$courtName','$casetype','$casesubtype','$casecat','$casesub','$caseName','$caseno','$caseyear','$caseDesc')";
    // echo $sql;
...
//  if (!file_exists("../TestingFolder/$clientName/$caseName")) {
//    mkdir("../TestingFolder/$clientName/$caseName", 0777, true);
//    echo "../TestingFolder/$clientName/$caseName";
//    echo 'folder created';
//   }
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6  col-md-6 col-sm-12">
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select" required placeholder="Please Select Client Name"onchange="document.getElementById('text_CN').value = this.options[this.selectedIndex].text">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="continer">
              <label class="font-weight-bold">Select Category</label>
              <select class="" id="selects" placeholder="Choose Category..">
   <option value="" disabled selected>Choose case Category</option>
      ...
      <div class="modal-body">
          <div class="continer border">
            <label class="font-weight-bold">Select Sub-Category</label>
              <select class="" id="editSC" placeholder="Choose Sub-Category..">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="continer border">
              ...
              <select class="" id="DeleteSC" placeholder="Choose Sub-Category..">
   <option value="" disabled selected>Please Choose Sub Category</option>
